        ...
        <table class="auto-style3">
            <tr>
                ...
                <td>
                    ...
                    <asp:GridView ID="oderItemGridView1" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" CellPadding="4" DataKeyNames="orderItem_Id" DataSourceID="orderItemDataSource1" ForeColor="#333333" GridLines="None" AllowSorting="True" OnDataBound="oderItemGridView1_DataBound1" OnRowDataBound="oderItemGridView1_RowDataBound1" OnRowDeleted="oderItemGridView1_RowDeleted">
                    ...
                    <asp:Button ID="addmoney" runat="server" OnClick="addmoney_Click" Text="儲值" Visible="False" />
                    <asp:Label ID="addLB" runat="server" Text="一次儲值100元" Visible="False"></asp:Label>
                    <br />
                    <br />
