...
<body style="background-size: cover;background-image: url('b1a7659daeaa88290aa1f1705ff3c433.jpg'); background-repeat: no-repeat; background-attachment: fixed; background-position: center center">
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:GridView ID="favoriteQueryGridView" runat="server" AutoGenerateColumns="False" AutoGenerateDeleteButton="True" CellPadding="4" DataKeyNames="drink_Id" DataSourceID="favoriteQuerySqlDataSource" ForeColor="#333333" GridLines="None">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:BoundField DataField="drink_Id" HeaderText="drink_Id" SortExpression="drink_Id" />
                    <asp:BoundField DataField="drink_name" HeaderText="drink_name" SortExpression="drink_name" />
